package com.nexoralabs.flowtrack.sales.domain.model.aggregates;

import com.nexoralabs.flowtrack.sales.domain.model.commands.CreateSaleCommand;
import com.nexoralabs.flowtrack.sales.domain.model.entities.SaleDetail;
import com.nexoralabs.flowtrack.sales.domain.model.valueobjects.ProductId;
import com.nexoralabs.flowtrack.sales.domain.model.valueobjects.StaffUserId;
    ...
    public Sale(CreateSaleCommand command) {
        ...
        if (Math.abs(this.totalAmount - command.totalAmount()) > 0.01) {
            ...
            throw new IllegalArgumentException(
                    "Total amount mismatch: calculated " + this.totalAmount + ", expected " + command.totalAmount());
        }
    }
