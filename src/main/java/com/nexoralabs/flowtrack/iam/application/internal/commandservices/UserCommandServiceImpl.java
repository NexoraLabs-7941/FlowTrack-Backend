...
import com.nexoralabs.flowtrack.iam.application.internal.outboundservices.tokens.TokenService;
import com.nexoralabs.flowtrack.iam.domain.model.aggregates.User;
import com.nexoralabs.flowtrack.iam.domain.model.commands.CreateUserCommand;
import com.nexoralabs.flowtrack.iam.domain.model.commands.SignInCommand;
import com.nexoralabs.flowtrack.iam.domain.model.commands.SignUpCommand;
import com.nexoralabs.flowtrack.iam.domain.model.commands.UpdateUserCommand;
...
import com.nexoralabs.flowtrack.iam.domain.services.UserCommandService;
...
import com.nexoralabs.flowtrack.iam.interfaces.acl.UserPermissionContextFacade;
 ...
 * {@link SignInCommand}, {@link SignUpCommand}, {@link CreateUserCommand}, and
 * {@link UpdateUserCommand} commands.
 * </p>
 */
@Service
public class UserCommandServiceImpl implements UserCommandService {
     ...
     * <p>
     * This method handles the {@link SignUpCommand} command and returns the created
     * user.
     * Sign-up creates an ADMIN user (business owner) with ALL permissions
     * automatically.
     * </p>
     * 
     ...
     * <p>
     * This method handles the {@link CreateUserCommand} command and returns the
     * created user.
     * Users created by admin always get ROLE_USER. Permissions control access to
     * specific modules.
     * </p>
     * 
     * @param command the create user command containing the email, password and
     *                permissions
     ...
     * <p>
     * This method handles the {@link UpdateUserCommand} command and returns the
     * updated user.
     * All fields are optional - only provided fields will be updated.
     * </p>
     * 
     * @param command the update user command containing the user ID, email
     *                (optional), password (optional) and permissions (optional)
     * @return the updated user
     * @throws RuntimeException if the user is not found or the email is already
