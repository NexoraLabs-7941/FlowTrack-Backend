package com.nexoralabs.flowtrack.iam.domain.model.aggregates;
...
public class User extends AuditableAbstractAggregateRoot<User> {
    ...
    public boolean isAdmin() {
        return roles.stream()
                .anyMatch(role -> role.getName() == com.nexoralabs.flowtrack.iam.domain.model.valueobjects.Roles.ROLE_ADMIN);
    }
}
